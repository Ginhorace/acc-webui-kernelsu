// Lightweight dialog utilities for environments where native prompt() may be unavailable (e.g., KernelSU WebView)
// Exposes: window.ensurePromptDom, window.customPrompt, window.promptCompat

(function () {
  function ensurePromptDom() {
    if (document.getElementById('custom-prompt-mask') && document.getElementById('custom-prompt-dialog')) return;
  ...
  // expose to global
  window.ensurePromptDom = ensurePromptDom;
  window.customPrompt = customPrompt;
  window.promptCompat = promptCompat;
})();
